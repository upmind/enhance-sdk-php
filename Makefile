...
shell:
	docker compose exec -it enhance-sdk-php /bin/bash

# Run Unit Tests (PHPUnit)
unit-test:
	docker compose exec enhance-sdk-php ./vendor/bin/phpunit

# Run Static Analysis (PHPStan)
static-analysis:
	docker compose exec enhance-sdk-php ./vendor/bin/phpstan analyse --memory-limit=1G

coding-standards:
	docker compose exec enhance-sdk-php php ./bin/php-cs-fixer-v3.phar fix --config=./.php-cs-fixer.dist.php
...
composer-install:
	docker compose exec enhance-sdk-php composer install --no-interaction
...
--remove-lockfile:
	docker compose exec enhance-sdk-php rm -f ./composer.lock

# Remove vendor directory
--remove-vendor:
	docker compose exec enhance-sdk-php rm -rf ./vendor
