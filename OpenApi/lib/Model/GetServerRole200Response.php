...
class GetServerRole200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'settings' => '\Upmind\EnhanceSdk\Model\RoleServiceSettings',
        'usage' => 'int',
        'mailbox_count' => 'int',
        ...
        'bkupd' => '\Upmind\EnhanceSdk\Model\ServiceInfo',
        'mysql_stats' => 'object',
        'mysqlcd' => '\Upmind\EnhanceSdk\Model\ServiceInfo',
        'apachecd' => '\Upmind\EnhanceSdk\Model\ServiceInfo',
        'phpcds' => '\Upmind\EnhanceSdk\Model\ServiceInfo[]',
        'filerd' => '\Upmind\EnhanceSdk\Model\ServiceInfo',
        'sshcd' => '\Upmind\EnhanceSdk\Model\ServiceInfo',
        'screenshotd' => '\Upmind\EnhanceSdk\Model\ServiceInfo',
        'ftpcd' => '\Upmind\EnhanceSdk\Model\ServiceInfo',
        'nginxcd' => '\Upmind\EnhanceSdk\Model\ServiceInfo',
        'zones_count' => 'int',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['apachecd'] === null) {
            $invalidProperties[] = "'apachecd' can't be null";
        }
        if ($this->container['filerd'] === null) {
            $invalidProperties[] = "'filerd' can't be null";
        }
        if ($this->container['sshcd'] === null) {
            $invalidProperties[] = "'sshcd' can't be null";
        }
        ...
        if ($this->container['nginxcd'] === null) {
            $invalidProperties[] = "'nginxcd' can't be null";
        }
     ...
     * Gets settings
     *
     * @return \Upmind\EnhanceSdk\Model\RoleServiceSettings
     */
     ...
     * Sets settings
     *
     * @param \Upmind\EnhanceSdk\Model\RoleServiceSettings $settings settings
     *
     * @return self
     */
     ...
     * Sets bkupd
     *
     * @param \Upmind\EnhanceSdk\Model\ServiceInfo $bkupd bkupd
     *
     * @return self
     */
     ...
     * Sets mysqlcd
     *
     * @param \Upmind\EnhanceSdk\Model\ServiceInfo $mysqlcd mysqlcd
     *
     * @return self
     */
     ...
     * Sets apachecd
     *
     * @param \Upmind\EnhanceSdk\Model\ServiceInfo $apachecd apachecd
     *
     * @return self
     */
     ...
     * Gets phpcds
     *
     * @return \Upmind\EnhanceSdk\Model\ServiceInfo[]|null
     */
    public function getPhpcds()
    {
        return $this->container['phpcds'];
    }

    /**
     * Sets phpcds
     *
     * @param \Upmind\EnhanceSdk\Model\ServiceInfo[]|null $phpcds phpcds
     *
     * @return self
     */
    public function setPhpcds($phpcds)
    {

        if (is_null($phpcds)) {
            throw new \InvalidArgumentException('non-nullable phpcds cannot be null');
        }

        $this->container['phpcds'] = $phpcds;
     ...
     * Sets filerd
     *
     * @param \Upmind\EnhanceSdk\Model\ServiceInfo $filerd filerd
     *
     * @return self
     */
     ...
     * @return \Upmind\EnhanceSdk\Model\ServiceInfo
     */
    public function getSshcd()
    {
        return $this->container['sshcd'];
    }

    /**
     * Sets sshcd
     *
     * @param \Upmind\EnhanceSdk\Model\ServiceInfo $sshcd sshcd
     *
     * @return self
     */
    public function setSshcd($sshcd)
    {

        if (is_null($sshcd)) {
            throw new \InvalidArgumentException('non-nullable sshcd cannot be null');
        }

        $this->container['sshcd'] = $sshcd;
     ...
     * Sets screenshotd
     *
     * @param \Upmind\EnhanceSdk\Model\ServiceInfo $screenshotd screenshotd
     *
     * @return self
     */
     ...
     * Sets ftpcd
     *
     * @param \Upmind\EnhanceSdk\Model\ServiceInfo $ftpcd ftpcd
     *
     * @return self
     */
     ...
     * @return \Upmind\EnhanceSdk\Model\ServiceInfo
     */
    public function getNginxcd()
    {
        return $this->container['nginxcd'];
    }

    /**
     * Sets nginxcd
     *
     * @param \Upmind\EnhanceSdk\Model\ServiceInfo $nginxcd nginxcd
     *
     * @return self
     */
    public function setNginxcd($nginxcd)
    {

        if (is_null($nginxcd)) {
            throw new \InvalidArgumentException('non-nullable nginxcd cannot be null');
        }

        $this->container['nginxcd'] = $nginxcd;
