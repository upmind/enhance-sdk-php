...
class BackupsApi
{
     ...
     * @param  \Upmind\EnhanceSdk\Model\BackupOptions|null $backup_options backup_options (optional)
     ...
     * @param  string $website_id The id of the website. (required)
     * @param  bool|null $include_emails The boolean flag used to include emails in the backup. (optional, default to false)
     * @param  \Upmind\EnhanceSdk\Model\BackupOptions|null $backup_options (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['backupWebsite'] to see the possible values for this operation
     *
     * @throws \Upmind\EnhanceSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  \Upmind\EnhanceSdk\Model\BackupStorageKind|null $storage_kind The storage kind of the requested backup. (optional)
     ...
     *
     * @param  string $website_id The id of the website. (required)
     * @param  \Upmind\EnhanceSdk\Model\BackupDownloadKind|null $backup_download_kind backup_download_kind (optional)
     ...
     *
     * @param  string $website_id The id of the website. (required)
     * @param  \Upmind\EnhanceSdk\Model\BackupDownloadKind|null $backup_download_kind (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['downloadWebsiteBackup'] to see the possible values for this operation
     *
     * @throws \Upmind\EnhanceSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    /**
     * Operation getWebsiteBackupDirectoryTree
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getWebsiteBackupDirectoryTree'] to see the possible values for this operation
     *
     * @throws \Upmind\EnhanceSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Upmind\EnhanceSdk\Model\DirectoryTreeNode[]
     */
    public function getWebsiteBackupDirectoryTree($org_id, $website_id, $backup_id, $offset = null, string $contentType = self::contentTypes['getWebsiteBackupDirectoryTree'][0])
    {
        list($response) = $this->getWebsiteBackupDirectoryTreeWithHttpInfo($org_id, $website_id, $backup_id, $offset, $contentType);
        return $response;
    }

    /**
     * Operation getWebsiteBackupDirectoryTreeWithHttpInfo
     *
     * Get the directory tree for the home dir
     *
     * @param  string $org_id The id of the organization. (required)
     ...
     * @throws \Upmind\EnhanceSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Upmind\EnhanceSdk\Model\DirectoryTreeNode[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getWebsiteBackupDirectoryTreeWithHttpInfo($org_id, $website_id, $backup_id, $offset = null, string $contentType = self::contentTypes['getWebsiteBackupDirectoryTree'][0])
    {
        $request = $this->getWebsiteBackupDirectoryTreeRequest($org_id, $website_id, $backup_id, $offset, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Upmind\EnhanceSdk\Model\DirectoryTreeNode[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Upmind\EnhanceSdk\Model\DirectoryTreeNode[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Upmind\EnhanceSdk\Model\DirectoryTreeNode[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Upmind\EnhanceSdk\Model\DirectoryTreeNode[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Upmind\EnhanceSdk\Model\DirectoryTreeNode[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getWebsiteBackupDirectoryTreeAsync
     *
     * Get the directory tree for the home dir
     *
     * @param  string $org_id The id of the organization. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWebsiteBackupDirectoryTreeAsync($org_id, $website_id, $backup_id, $offset = null, string $contentType = self::contentTypes['getWebsiteBackupDirectoryTree'][0])
    {
        return $this->getWebsiteBackupDirectoryTreeAsyncWithHttpInfo($org_id, $website_id, $backup_id, $offset, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getWebsiteBackupDirectoryTreeAsyncWithHttpInfo
     *
     * Get the directory tree for the home dir
     *
     * @param  string $org_id The id of the organization. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWebsiteBackupDirectoryTreeAsyncWithHttpInfo($org_id, $website_id, $backup_id, $offset = null, string $contentType = self::contentTypes['getWebsiteBackupDirectoryTree'][0])
    {
        $returnType = '\Upmind\EnhanceSdk\Model\DirectoryTreeNode[]';
        $request = $this->getWebsiteBackupDirectoryTreeRequest($org_id, $website_id, $backup_id, $offset, $contentType);
    ...
    /**
     * Create request for operation 'getWebsiteBackupDirectoryTree'
     *
     * @param  string $org_id The id of the organization. (required)
     * @param  string $website_id The id of the website. (required)
     * @param  int $backup_id The id of the backup. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getWebsiteBackupDirectoryTreeRequest($org_id, $website_id, $backup_id, $offset = null, string $contentType = self::contentTypes['getWebsiteBackupDirectoryTree'][0])
    {

        // verify the required parameter 'org_id' is set
        if ($org_id === null || (is_array($org_id) && count($org_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $org_id when calling getWebsiteBackupDirectoryTree'
            );
        }
        ...
        if ($website_id === null || (is_array($website_id) && count($website_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $website_id when calling getWebsiteBackupDirectoryTree'
            );
        }
        ...
        if ($backup_id === null || (is_array($backup_id) && count($backup_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $backup_id when calling getWebsiteBackupDirectoryTree'
            );
        }



        $resourcePath = '/orgs/{org_id}/websites/{website_id}/backups/{backup_id}/directory_tree';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Upmind\EnhanceSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Upmind\EnhanceSdk\Model\RestoreDetailed
     */
     ...
     * @throws \Upmind\EnhanceSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Upmind\EnhanceSdk\Model\RestoreDetailed, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWebsiteRestoreStatusWithHttpInfo($org_id, $website_id, $backup_id, string $contentType = self::contentTypes['getWebsiteRestoreStatus'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Upmind\EnhanceSdk\Model\RestoreDetailed' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Upmind\EnhanceSdk\Model\RestoreDetailed' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Upmind\EnhanceSdk\Model\RestoreDetailed', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Upmind\EnhanceSdk\Model\RestoreDetailed';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Upmind\EnhanceSdk\Model\RestoreDetailed',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Upmind\EnhanceSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<string,\Upmind\EnhanceSdk\Model\GlobalWebsiteBackup[]>
     */
     ...
     * @throws \Upmind\EnhanceSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of array<string,\Upmind\EnhanceSdk\Model\GlobalWebsiteBackup[]>, HTTP status code, HTTP response headers (array of strings)
     */
    public function listGlobalBackupsWithHttpInfo($show_existing = null, string $contentType = self::contentTypes['listGlobalBackups'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('array<string,\Upmind\EnhanceSdk\Model\GlobalWebsiteBackup[]>' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('array<string,\Upmind\EnhanceSdk\Model\GlobalWebsiteBackup[]>' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, 'array<string,\Upmind\EnhanceSdk\Model\GlobalWebsiteBackup[]>', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = 'array<string,\Upmind\EnhanceSdk\Model\GlobalWebsiteBackup[]>';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @param  int $backup_id The id of the backup. (required)
     * @param  \Upmind\EnhanceSdk\Model\BackupStorageKind|null $storage_kind The storage kind of the requested backup. (optional)
     * @param  \Upmind\EnhanceSdk\Model\BackupRestoreOptions|null $backup_restore_options The options used to define what will be restored from the backup snapshot. (optional)
