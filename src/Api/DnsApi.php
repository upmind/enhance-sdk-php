...
class DnsApi
{
    ...
    /**
     * Operation updateDnsThirdPartyProvider
     *
     * Update a third party dns provider.
     *
     * @param  int $provider_id The id of the third party provider which can be obtained by querying the GET /dns/third-party-providers endpoint. (required)
     * @param  \Upmind\EnhanceSdk\Model\NewDnsThirdPartyProvider $new_dns_third_party_provider Url where the updates are sent and map of header names to their values. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateDnsThirdPartyProvider'] to see the possible values for this operation
     *
     * @throws \Upmind\EnhanceSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function updateDnsThirdPartyProvider($provider_id, $new_dns_third_party_provider, string $contentType = self::contentTypes['updateDnsThirdPartyProvider'][0])
    {
        $this->updateDnsThirdPartyProviderWithHttpInfo($provider_id, $new_dns_third_party_provider, $contentType);
    }

    /**
     * Operation updateDnsThirdPartyProviderWithHttpInfo
     *
     * Update a third party dns provider.
     *
     * @param  int $provider_id The id of the third party provider which can be obtained by querying the GET /dns/third-party-providers endpoint. (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateDnsThirdPartyProviderWithHttpInfo($provider_id, $new_dns_third_party_provider, string $contentType = self::contentTypes['updateDnsThirdPartyProvider'][0])
    {
        $request = $this->updateDnsThirdPartyProviderRequest($provider_id, $new_dns_third_party_provider, $contentType);
    ...
    /**
     * Operation updateDnsThirdPartyProviderAsync
     *
     * Update a third party dns provider.
     *
     * @param  int $provider_id The id of the third party provider which can be obtained by querying the GET /dns/third-party-providers endpoint. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateDnsThirdPartyProviderAsync($provider_id, $new_dns_third_party_provider, string $contentType = self::contentTypes['updateDnsThirdPartyProvider'][0])
    {
        return $this->updateDnsThirdPartyProviderAsyncWithHttpInfo($provider_id, $new_dns_third_party_provider, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateDnsThirdPartyProviderAsyncWithHttpInfo
     *
     * Update a third party dns provider.
     *
     * @param  int $provider_id The id of the third party provider which can be obtained by querying the GET /dns/third-party-providers endpoint. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateDnsThirdPartyProviderAsyncWithHttpInfo($provider_id, $new_dns_third_party_provider, string $contentType = self::contentTypes['updateDnsThirdPartyProvider'][0])
    {
        $returnType = '';
        $request = $this->updateDnsThirdPartyProviderRequest($provider_id, $new_dns_third_party_provider, $contentType);
    ...
    /**
     * Create request for operation 'updateDnsThirdPartyProvider'
     *
     * @param  int $provider_id The id of the third party provider which can be obtained by querying the GET /dns/third-party-providers endpoint. (required)
     * @param  \Upmind\EnhanceSdk\Model\NewDnsThirdPartyProvider $new_dns_third_party_provider Url where the updates are sent and map of header names to their values. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateDnsThirdPartyProvider'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateDnsThirdPartyProviderRequest($provider_id, $new_dns_third_party_provider, string $contentType = self::contentTypes['updateDnsThirdPartyProvider'][0])
    {

        // verify the required parameter 'provider_id' is set
        if ($provider_id === null || (is_array($provider_id) && count($provider_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $provider_id when calling updateDnsThirdPartyProvider'
            );
        }
        ...
        if ($new_dns_third_party_provider === null || (is_array($new_dns_third_party_provider) && count($new_dns_third_party_provider) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $new_dns_third_party_provider when calling updateDnsThirdPartyProvider'
            );
        }
