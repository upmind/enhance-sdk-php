...
class DomainsApi
{
    ...
    /**
     * Operation createWebsiteDomainMapping
     *
     ...
     * @return void
     */
    public function createWebsiteDomainMapping($org_id, $website_id, $domain_id, $domain_mapping_update)
    {
        $this->createWebsiteDomainMappingWithHttpInfo($org_id, $website_id, $domain_id, $domain_mapping_update);
    }

    /**
     * Operation createWebsiteDomainMappingWithHttpInfo
     *
     * Create website domain mapping
     *
     * @param  string $org_id The id of the organization. (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWebsiteDomainMappingWithHttpInfo($org_id, $website_id, $domain_id, $domain_mapping_update)
    {
        $request = $this->createWebsiteDomainMappingRequest($org_id, $website_id, $domain_id, $domain_mapping_update);
    ...
    /**
     * Operation createWebsiteDomainMappingAsync
     *
     * Create website domain mapping
     *
     * @param  string $org_id The id of the organization. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createWebsiteDomainMappingAsync($org_id, $website_id, $domain_id, $domain_mapping_update)
    {
        return $this->createWebsiteDomainMappingAsyncWithHttpInfo($org_id, $website_id, $domain_id, $domain_mapping_update)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createWebsiteDomainMappingAsyncWithHttpInfo
     *
     * Create website domain mapping
     *
     * @param  string $org_id The id of the organization. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createWebsiteDomainMappingAsyncWithHttpInfo($org_id, $website_id, $domain_id, $domain_mapping_update)
    {
        $returnType = '';
        $request = $this->createWebsiteDomainMappingRequest($org_id, $website_id, $domain_id, $domain_mapping_update);
    ...
    /**
     * Create request for operation 'createWebsiteDomainMapping'
     *
     * @param  string $org_id The id of the organization. (required)
     * @param  string $website_id The id of the website. (required)
     * @param  string $domain_id The id of the domain. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createWebsiteDomainMappingRequest($org_id, $website_id, $domain_id, $domain_mapping_update)
    {

        // verify the required parameter 'org_id' is set
        if ($org_id === null || (is_array($org_id) && count($org_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $org_id when calling createWebsiteDomainMapping'
            );
        }
        ...
        if ($website_id === null || (is_array($website_id) && count($website_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $website_id when calling createWebsiteDomainMapping'
            );
        }
        ...
        if ($domain_id === null || (is_array($domain_id) && count($domain_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $domain_id when calling createWebsiteDomainMapping'
            );
        }
        ...
        if ($domain_mapping_update === null || (is_array($domain_mapping_update) && count($domain_mapping_update) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $domain_mapping_update when calling createWebsiteDomainMapping'
            );
        }
