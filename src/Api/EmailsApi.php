...
class EmailsApi
{
     ...
     * @param  string $website_id The id of the website. (required)
     * @param  string $email_address The address of the email. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ssoToRoundcube'] to see the possible values for this operation
     *
     * @throws \Upmind\EnhanceSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function ssoToRoundcube($org_id, $website_id, $email_address, string $contentType = self::contentTypes['ssoToRoundcube'][0])
    {
        $this->ssoToRoundcubeWithHttpInfo($org_id, $website_id, $email_address, $contentType);
    }

    /**
     * Operation ssoToRoundcubeWithHttpInfo
     *
     * SSO to Roundcube
     *
     * @param  string $org_id The id of the organization. (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function ssoToRoundcubeWithHttpInfo($org_id, $website_id, $email_address, string $contentType = self::contentTypes['ssoToRoundcube'][0])
    {
        $request = $this->ssoToRoundcubeRequest($org_id, $website_id, $email_address, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ssoToRoundcubeAsync($org_id, $website_id, $email_address, string $contentType = self::contentTypes['ssoToRoundcube'][0])
    {
        return $this->ssoToRoundcubeAsyncWithHttpInfo($org_id, $website_id, $email_address, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation ssoToRoundcubeAsyncWithHttpInfo
     *
     * SSO to Roundcube
     *
     * @param  string $org_id The id of the organization. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ssoToRoundcubeAsyncWithHttpInfo($org_id, $website_id, $email_address, string $contentType = self::contentTypes['ssoToRoundcube'][0])
    {
        $returnType = '';
        $request = $this->ssoToRoundcubeRequest($org_id, $website_id, $email_address, $contentType);
    ...
    /**
     * Create request for operation 'ssoToRoundcube'
     *
     * @param  string $org_id The id of the organization. (required)
     * @param  string $website_id The id of the website. (required)
     * @param  string $email_address The address of the email. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ssoToRoundcubeRequest($org_id, $website_id, $email_address, string $contentType = self::contentTypes['ssoToRoundcube'][0])
    {

        // verify the required parameter 'org_id' is set
        if ($org_id === null || (is_array($org_id) && count($org_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $org_id when calling ssoToRoundcube'
            );
        }
        ...
        if ($website_id === null || (is_array($website_id) && count($website_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $website_id when calling ssoToRoundcube'
            );
        }
        ...
        if ($email_address === null || (is_array($email_address) && count($email_address) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $email_address when calling ssoToRoundcube'
            );
        }


        $resourcePath = '/orgs/{org_id}/websites/{website_id}/emails/{email_address}/sso';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
