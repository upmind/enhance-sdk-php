...
class EmailsApi
{
    ...
    public function createWebsiteEmailAutoresponderRequest($org_id, $website_id, $email_id, $new_autoresponder, string $contentType = self::contentTypes['createWebsiteEmailAutoresponder'][0])
    {
        ...
        $resourcePath = '/orgs/{org_id}/websites/{website_id}/emails/{email_id}/autoresponder';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return void
     */
    public function deleteWebsiteEmailAutoresponder($org_id, $website_id, $email_id, string $contentType = self::contentTypes['deleteWebsiteEmailAutoresponder'][0])
    {
        $this->deleteWebsiteEmailAutoresponderWithHttpInfo($org_id, $website_id, $email_id, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteWebsiteEmailAutoresponderWithHttpInfo($org_id, $website_id, $email_id, string $contentType = self::contentTypes['deleteWebsiteEmailAutoresponder'][0])
    {
        $request = $this->deleteWebsiteEmailAutoresponderRequest($org_id, $website_id, $email_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteWebsiteEmailAutoresponderAsync($org_id, $website_id, $email_id, string $contentType = self::contentTypes['deleteWebsiteEmailAutoresponder'][0])
    {
        return $this->deleteWebsiteEmailAutoresponderAsyncWithHttpInfo($org_id, $website_id, $email_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteWebsiteEmailAutoresponderAsyncWithHttpInfo($org_id, $website_id, $email_id, string $contentType = self::contentTypes['deleteWebsiteEmailAutoresponder'][0])
    {
        $returnType = '';
        $request = $this->deleteWebsiteEmailAutoresponderRequest($org_id, $website_id, $email_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteWebsiteEmailAutoresponderRequest($org_id, $website_id, $email_id, string $contentType = self::contentTypes['deleteWebsiteEmailAutoresponder'][0])
    {
     ...
     * @throws \Upmind\EnhanceSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Upmind\EnhanceSdk\Model\SpamThresholds
     */
    public function getEmailSpamThresholds($email_id, string $contentType = self::contentTypes['getEmailSpamThresholds'][0])
    {
        list($response) = $this->getEmailSpamThresholdsWithHttpInfo($email_id, $contentType);
        return $response;
    }
     ...
     * @throws \Upmind\EnhanceSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Upmind\EnhanceSdk\Model\SpamThresholds, HTTP status code, HTTP response headers (array of strings)
     */
    public function getEmailSpamThresholdsWithHttpInfo($email_id, string $contentType = self::contentTypes['getEmailSpamThresholds'][0])
    {
        $request = $this->getEmailSpamThresholdsRequest($email_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Upmind\EnhanceSdk\Model\SpamThresholds' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Upmind\EnhanceSdk\Model\SpamThresholds' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Upmind\EnhanceSdk\Model\SpamThresholds', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Upmind\EnhanceSdk\Model\SpamThresholds';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Upmind\EnhanceSdk\Model\SpamThresholds',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailSpamThresholdsAsync($email_id, string $contentType = self::contentTypes['getEmailSpamThresholds'][0])
    {
        return $this->getEmailSpamThresholdsAsyncWithHttpInfo($email_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailSpamThresholdsAsyncWithHttpInfo($email_id, string $contentType = self::contentTypes['getEmailSpamThresholds'][0])
    {
        $returnType = '\Upmind\EnhanceSdk\Model\SpamThresholds';
        $request = $this->getEmailSpamThresholdsRequest($email_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getEmailSpamThresholdsRequest($email_id, string $contentType = self::contentTypes['getEmailSpamThresholds'][0])
    {

        // verify the required parameter 'email_id' is set
        if ($email_id === null || (is_array($email_id) && count($email_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $email_id when calling getEmailSpamThresholds'
            );
        }


        $resourcePath = '/emails/{email_id}/spam_thresholds';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function getWebsiteEmailAutoresponder($org_id, $website_id, $email_id, string $contentType = self::contentTypes['getWebsiteEmailAutoresponder'][0])
    {
        list($response) = $this->getWebsiteEmailAutoresponderWithHttpInfo($org_id, $website_id, $email_id, $contentType);
        return $response;
    }
     ...
     */
    public function getWebsiteEmailAutoresponderWithHttpInfo($org_id, $website_id, $email_id, string $contentType = self::contentTypes['getWebsiteEmailAutoresponder'][0])
    {
        $request = $this->getWebsiteEmailAutoresponderRequest($org_id, $website_id, $email_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWebsiteEmailAutoresponderAsync($org_id, $website_id, $email_id, string $contentType = self::contentTypes['getWebsiteEmailAutoresponder'][0])
    {
        return $this->getWebsiteEmailAutoresponderAsyncWithHttpInfo($org_id, $website_id, $email_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWebsiteEmailAutoresponderAsyncWithHttpInfo($org_id, $website_id, $email_id, string $contentType = self::contentTypes['getWebsiteEmailAutoresponder'][0])
    {
        $returnType = '\Upmind\EnhanceSdk\Model\Autoresponder';
        $request = $this->getWebsiteEmailAutoresponderRequest($org_id, $website_id, $email_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getWebsiteEmailAutoresponderRequest($org_id, $website_id, $email_id, string $contentType = self::contentTypes['getWebsiteEmailAutoresponder'][0])
    {
        ...
        if ($email_id === null || (is_array($email_id) && count($email_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $email_id when calling getWebsiteEmailAutoresponder'
            );
        }
     ...
     *
     * @param  string $email_id The id of the email. (required)
     * @param  \Upmind\EnhanceSdk\Model\SpamThresholds $spam_thresholds Spam thresholds. (required)
     ...
     * @return void
     */
    public function setEmailSpamThresholds($email_id, $spam_thresholds, string $contentType = self::contentTypes['setEmailSpamThresholds'][0])
    {
        $this->setEmailSpamThresholdsWithHttpInfo($email_id, $spam_thresholds, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function setEmailSpamThresholdsWithHttpInfo($email_id, $spam_thresholds, string $contentType = self::contentTypes['setEmailSpamThresholds'][0])
    {
        $request = $this->setEmailSpamThresholdsRequest($email_id, $spam_thresholds, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setEmailSpamThresholdsAsync($email_id, $spam_thresholds, string $contentType = self::contentTypes['setEmailSpamThresholds'][0])
    {
        return $this->setEmailSpamThresholdsAsyncWithHttpInfo($email_id, $spam_thresholds, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setEmailSpamThresholdsAsyncWithHttpInfo($email_id, $spam_thresholds, string $contentType = self::contentTypes['setEmailSpamThresholds'][0])
    {
        $returnType = '';
        $request = $this->setEmailSpamThresholdsRequest($email_id, $spam_thresholds, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function setEmailSpamThresholdsRequest($email_id, $spam_thresholds, string $contentType = self::contentTypes['setEmailSpamThresholds'][0])
    {

        // verify the required parameter 'email_id' is set
        if ($email_id === null || (is_array($email_id) && count($email_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $email_id when calling setEmailSpamThresholds'
            );
        }
