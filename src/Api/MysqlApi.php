...
class MysqlApi
{
    ...
    /**
     * Operation getPhpMyAdminWebsiteSSOUrl
     *
     ...
     * @param  string $website_id The id of the website. (required)
     * @param  bool|null $should_redirect If set to true, the endpoint will send a 307 redirect to the SSO URL. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getPhpMyAdminWebsiteSSOUrl'] to see the possible values for this operation
     *
     * @throws \Upmind\EnhanceSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return string
     */
    public function getPhpMyAdminWebsiteSSOUrl($org_id, $website_id, $should_redirect = null, string $contentType = self::contentTypes['getPhpMyAdminWebsiteSSOUrl'][0])
    {
        list($response) = $this->getPhpMyAdminWebsiteSSOUrlWithHttpInfo($org_id, $website_id, $should_redirect, $contentType);
        return $response;
    }

    /**
     * Operation getPhpMyAdminWebsiteSSOUrlWithHttpInfo
     *
     * Get phpMyAdmin SSO URL (per website)
     *
     * @param  string $org_id The id of the organization. (required)
     ...
     * @return array of string, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPhpMyAdminWebsiteSSOUrlWithHttpInfo($org_id, $website_id, $should_redirect = null, string $contentType = self::contentTypes['getPhpMyAdminWebsiteSSOUrl'][0])
    {
        $request = $this->getPhpMyAdminWebsiteSSOUrlRequest($org_id, $website_id, $should_redirect, $contentType);
    ...
    /**
     * Operation getPhpMyAdminWebsiteSSOUrlAsync
     *
     * Get phpMyAdmin SSO URL (per website)
     *
     * @param  string $org_id The id of the organization. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPhpMyAdminWebsiteSSOUrlAsync($org_id, $website_id, $should_redirect = null, string $contentType = self::contentTypes['getPhpMyAdminWebsiteSSOUrl'][0])
    {
        return $this->getPhpMyAdminWebsiteSSOUrlAsyncWithHttpInfo($org_id, $website_id, $should_redirect, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getPhpMyAdminWebsiteSSOUrlAsyncWithHttpInfo
     *
     * Get phpMyAdmin SSO URL (per website)
     *
     * @param  string $org_id The id of the organization. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPhpMyAdminWebsiteSSOUrlAsyncWithHttpInfo($org_id, $website_id, $should_redirect = null, string $contentType = self::contentTypes['getPhpMyAdminWebsiteSSOUrl'][0])
    {
        $returnType = 'string';
        $request = $this->getPhpMyAdminWebsiteSSOUrlRequest($org_id, $website_id, $should_redirect, $contentType);
    ...
    /**
     * Create request for operation 'getPhpMyAdminWebsiteSSOUrl'
     *
     * @param  string $org_id The id of the organization. (required)
     * @param  string $website_id The id of the website. (required)
     * @param  bool|null $should_redirect If set to true, the endpoint will send a 307 redirect to the SSO URL. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPhpMyAdminWebsiteSSOUrlRequest($org_id, $website_id, $should_redirect = null, string $contentType = self::contentTypes['getPhpMyAdminWebsiteSSOUrl'][0])
    {

        // verify the required parameter 'org_id' is set
        if ($org_id === null || (is_array($org_id) && count($org_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $org_id when calling getPhpMyAdminWebsiteSSOUrl'
            );
        }
        ...
        if ($website_id === null || (is_array($website_id) && count($website_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $website_id when calling getPhpMyAdminWebsiteSSOUrl'
            );
        }



        $resourcePath = '/orgs/{org_id}/websites/{website_id}/phpmyadmin';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
