...
class ServersApi
{
     ...
     * @throws \Upmind\EnhanceSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Upmind\EnhanceSdk\Model\ServiceLogsFullListing
     */
    public function getServerLogs($server_id, $since = null, $until = null, $limit = null, $flush = null)
    {
        list($response) = $this->getServerLogsWithHttpInfo($server_id, $since, $until, $limit, $flush);
        return $response;
    }
     ...
     * @throws \Upmind\EnhanceSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Upmind\EnhanceSdk\Model\ServiceLogsFullListing, HTTP status code, HTTP response headers (array of strings)
     */
    public function getServerLogsWithHttpInfo($server_id, $since = null, $until = null, $limit = null, $flush = null)
    {
        $request = $this->getServerLogsRequest($server_id, $since, $until, $limit, $flush);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\Upmind\EnhanceSdk\Model\ServiceLogsFullListing' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Upmind\EnhanceSdk\Model\ServiceLogsFullListing' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Upmind\EnhanceSdk\Model\ServiceLogsFullListing', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Upmind\EnhanceSdk\Model\ServiceLogsFullListing';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Upmind\EnhanceSdk\Model\ServiceLogsFullListing',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getServerLogsAsync($server_id, $since = null, $until = null, $limit = null, $flush = null)
    {
        return $this->getServerLogsAsyncWithHttpInfo($server_id, $since, $until, $limit, $flush)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getServerLogsAsyncWithHttpInfo($server_id, $since = null, $until = null, $limit = null, $flush = null)
    {
        $returnType = '\Upmind\EnhanceSdk\Model\ServiceLogsFullListing';
        $request = $this->getServerLogsRequest($server_id, $since, $until, $limit, $flush);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getServerLogsRequest($server_id, $since = null, $until = null, $limit = null, $flush = null)
    {
        ...
        $resourcePath = '/servers/{server_id}/logs';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation updateControlPanelRole
     *
     * Update master server control panel role info
     *
     * @param  \Upmind\EnhanceSdk\Model\UpdateControl $update_control Info for updating the control panel role. (required)
     *
     * @throws \Upmind\EnhanceSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function updateControlPanelRole($update_control)
    {
        $this->updateControlPanelRoleWithHttpInfo($update_control);
    }

    /**
     * Operation updateControlPanelRoleWithHttpInfo
     *
     * Update master server control panel role info
     *
     * @param  \Upmind\EnhanceSdk\Model\UpdateControl $update_control Info for updating the control panel role. (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateControlPanelRoleWithHttpInfo($update_control)
    {
        $request = $this->updateControlPanelRoleRequest($update_control);
    ...
    /**
     * Operation updateControlPanelRoleAsync
     *
     * Update master server control panel role info
     *
     * @param  \Upmind\EnhanceSdk\Model\UpdateControl $update_control Info for updating the control panel role. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateControlPanelRoleAsync($update_control)
    {
        return $this->updateControlPanelRoleAsyncWithHttpInfo($update_control)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateControlPanelRoleAsyncWithHttpInfo
     *
     * Update master server control panel role info
     *
     * @param  \Upmind\EnhanceSdk\Model\UpdateControl $update_control Info for updating the control panel role. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateControlPanelRoleAsyncWithHttpInfo($update_control)
    {
        $returnType = '';
        $request = $this->updateControlPanelRoleRequest($update_control);
    ...
    /**
     * Create request for operation 'updateControlPanelRole'
     *
     * @param  \Upmind\EnhanceSdk\Model\UpdateControl $update_control Info for updating the control panel role. (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateControlPanelRoleRequest($update_control)
    {

        // verify the required parameter 'update_control' is set
        if ($update_control === null || (is_array($update_control) && count($update_control) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $update_control when calling updateControlPanelRole'
            );
        }
        ...
        // for model (json/xml)
        if (isset($update_control)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($update_control));
            } else {
                $httpBody = $update_control;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
