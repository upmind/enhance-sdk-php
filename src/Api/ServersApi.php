...
class ServersApi
{
    ...
    /**
     * Operation getRoundcubeSsoEnabled
     *
     * Check if Roundcube SSO is enabled on this server
     *
     * @param  string $server_id The UUID of the server (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getRoundcubeSsoEnabled'] to see the possible values for this operation
     *
     * @throws \Upmind\EnhanceSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return bool
     */
    public function getRoundcubeSsoEnabled($server_id, string $contentType = self::contentTypes['getRoundcubeSsoEnabled'][0])
    {
        list($response) = $this->getRoundcubeSsoEnabledWithHttpInfo($server_id, $contentType);
        return $response;
    }

    /**
     * Operation getRoundcubeSsoEnabledWithHttpInfo
     *
     * Check if Roundcube SSO is enabled on this server
     *
     * @param  string $server_id The UUID of the server (required)
     ...
     */
    public function getRoundcubeSsoEnabledWithHttpInfo($server_id, string $contentType = self::contentTypes['getRoundcubeSsoEnabled'][0])
    {
        $request = $this->getRoundcubeSsoEnabledRequest($server_id, $contentType);
    ...
    /**
     * Operation getRoundcubeSsoEnabledAsync
     *
     * Check if Roundcube SSO is enabled on this server
     *
     * @param  string $server_id The UUID of the server (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRoundcubeSsoEnabledAsync($server_id, string $contentType = self::contentTypes['getRoundcubeSsoEnabled'][0])
    {
        return $this->getRoundcubeSsoEnabledAsyncWithHttpInfo($server_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getRoundcubeSsoEnabledAsyncWithHttpInfo
     *
     * Check if Roundcube SSO is enabled on this server
     *
     * @param  string $server_id The UUID of the server (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRoundcubeSsoEnabledAsyncWithHttpInfo($server_id, string $contentType = self::contentTypes['getRoundcubeSsoEnabled'][0])
    {
        $returnType = 'bool';
        $request = $this->getRoundcubeSsoEnabledRequest($server_id, $contentType);
    ...
    /**
     * Create request for operation 'getRoundcubeSsoEnabled'
     *
     * @param  string $server_id The UUID of the server (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getRoundcubeSsoEnabled'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getRoundcubeSsoEnabledRequest($server_id, string $contentType = self::contentTypes['getRoundcubeSsoEnabled'][0])
    {

        // verify the required parameter 'server_id' is set
        if ($server_id === null || (is_array($server_id) && count($server_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $server_id when calling getRoundcubeSsoEnabled'
            );
        }


        $resourcePath = '/servers/{server_id}/roundcube_sso_enabled';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $server_id The UUID of the server (required)
     * @param  \Upmind\EnhanceSdk\Model\ServerRole $role The role of the server. (required)
     * @param  bool|null $disable_role_on_installation Disable placement immediately after installation (optional)
     ...
     */
    public function getServerRole($server_id, $role, $disable_role_on_installation = null, string $contentType = self::contentTypes['getServerRole'][0])
    {
        list($response) = $this->getServerRoleWithHttpInfo($server_id, $role, $disable_role_on_installation, $contentType);
        return $response;
    }
     ...
     */
    public function getServerRoleWithHttpInfo($server_id, $role, $disable_role_on_installation = null, string $contentType = self::contentTypes['getServerRole'][0])
    {
        $request = $this->getServerRoleRequest($server_id, $role, $disable_role_on_installation, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getServerRoleAsync($server_id, $role, $disable_role_on_installation = null, string $contentType = self::contentTypes['getServerRole'][0])
    {
        return $this->getServerRoleAsyncWithHttpInfo($server_id, $role, $disable_role_on_installation, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getServerRoleAsyncWithHttpInfo($server_id, $role, $disable_role_on_installation = null, string $contentType = self::contentTypes['getServerRole'][0])
    {
        $returnType = '\Upmind\EnhanceSdk\Model\GetServerRole200Response';
        $request = $this->getServerRoleRequest($server_id, $role, $disable_role_on_installation, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getServerRoleRequest($server_id, $role, $disable_role_on_installation = null, string $contentType = self::contentTypes['getServerRole'][0])
    {
        ...
        // query params
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $disable_role_on_installation,
            'disable_role_on_installation', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
    ...
    /**
     * Operation getServerSpecs
     *
     * Get server specs
     *
     * @param  string $server_id The UUID of the server (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getServerSpecs'] to see the possible values for this operation
     *
     * @throws \Upmind\EnhanceSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Upmind\EnhanceSdk\Model\ServerSpecs
     */
    public function getServerSpecs($server_id, string $contentType = self::contentTypes['getServerSpecs'][0])
    {
        list($response) = $this->getServerSpecsWithHttpInfo($server_id, $contentType);
        return $response;
    }

    /**
     * Operation getServerSpecsWithHttpInfo
     *
     * Get server specs
     *
     * @param  string $server_id The UUID of the server (required)
     ...
     * @throws \Upmind\EnhanceSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Upmind\EnhanceSdk\Model\ServerSpecs, HTTP status code, HTTP response headers (array of strings)
     */
    public function getServerSpecsWithHttpInfo($server_id, string $contentType = self::contentTypes['getServerSpecs'][0])
    {
        $request = $this->getServerSpecsRequest($server_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Upmind\EnhanceSdk\Model\ServerSpecs' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Upmind\EnhanceSdk\Model\ServerSpecs' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Upmind\EnhanceSdk\Model\ServerSpecs', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Upmind\EnhanceSdk\Model\ServerSpecs';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Upmind\EnhanceSdk\Model\ServerSpecs',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getServerSpecsAsync($server_id, string $contentType = self::contentTypes['getServerSpecs'][0])
    {
        return $this->getServerSpecsAsyncWithHttpInfo($server_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getServerSpecsAsyncWithHttpInfo
     *
     * Get server specs
     *
     * @param  string $server_id The UUID of the server (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getServerSpecsAsyncWithHttpInfo($server_id, string $contentType = self::contentTypes['getServerSpecs'][0])
    {
        $returnType = '\Upmind\EnhanceSdk\Model\ServerSpecs';
        $request = $this->getServerSpecsRequest($server_id, $contentType);
    ...
    /**
     * Create request for operation 'getServerSpecs'
     *
     * @param  string $server_id The UUID of the server (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getServerSpecs'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getServerSpecsRequest($server_id, string $contentType = self::contentTypes['getServerSpecs'][0])
    {

        // verify the required parameter 'server_id' is set
        if ($server_id === null || (is_array($server_id) && count($server_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $server_id when calling getServerSpecs'
            );
        }


        $resourcePath = '/servers/{server_id}/specs';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return void
     */
    public function installServerRole($server_id, $role, $disable_role_on_installation = null, $new_backup_role = null, string $contentType = self::contentTypes['installServerRole'][0])
    {
        $this->installServerRoleWithHttpInfo($server_id, $role, $disable_role_on_installation, $new_backup_role, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function installServerRoleWithHttpInfo($server_id, $role, $disable_role_on_installation = null, $new_backup_role = null, string $contentType = self::contentTypes['installServerRole'][0])
    {
        $request = $this->installServerRoleRequest($server_id, $role, $disable_role_on_installation, $new_backup_role, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function installServerRoleAsync($server_id, $role, $disable_role_on_installation = null, $new_backup_role = null, string $contentType = self::contentTypes['installServerRole'][0])
    {
        return $this->installServerRoleAsyncWithHttpInfo($server_id, $role, $disable_role_on_installation, $new_backup_role, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function installServerRoleAsyncWithHttpInfo($server_id, $role, $disable_role_on_installation = null, $new_backup_role = null, string $contentType = self::contentTypes['installServerRole'][0])
    {
        $returnType = '';
        $request = $this->installServerRoleRequest($server_id, $role, $disable_role_on_installation, $new_backup_role, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function installServerRoleRequest($server_id, $role, $disable_role_on_installation = null, $new_backup_role = null, string $contentType = self::contentTypes['installServerRole'][0])
    {
    ...
    /**
     * Operation setRoundcubeSsoEnabled
     *
     * Set Roundcube SSO enabled state
     *
     * @param  string $server_id The UUID of the server (required)
     * @param  bool $body body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['setRoundcubeSsoEnabled'] to see the possible values for this operation
     *
     * @throws \Upmind\EnhanceSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function setRoundcubeSsoEnabled($server_id, $body, string $contentType = self::contentTypes['setRoundcubeSsoEnabled'][0])
    {
        $this->setRoundcubeSsoEnabledWithHttpInfo($server_id, $body, $contentType);
    }

    /**
     * Operation setRoundcubeSsoEnabledWithHttpInfo
     *
     * Set Roundcube SSO enabled state
     *
     * @param  string $server_id The UUID of the server (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function setRoundcubeSsoEnabledWithHttpInfo($server_id, $body, string $contentType = self::contentTypes['setRoundcubeSsoEnabled'][0])
    {
        $request = $this->setRoundcubeSsoEnabledRequest($server_id, $body, $contentType);
    ...
    /**
     * Operation setRoundcubeSsoEnabledAsync
     *
     * Set Roundcube SSO enabled state
     *
     * @param  string $server_id The UUID of the server (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setRoundcubeSsoEnabledAsync($server_id, $body, string $contentType = self::contentTypes['setRoundcubeSsoEnabled'][0])
    {
        return $this->setRoundcubeSsoEnabledAsyncWithHttpInfo($server_id, $body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation setRoundcubeSsoEnabledAsyncWithHttpInfo
     *
     * Set Roundcube SSO enabled state
     *
     * @param  string $server_id The UUID of the server (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setRoundcubeSsoEnabledAsyncWithHttpInfo($server_id, $body, string $contentType = self::contentTypes['setRoundcubeSsoEnabled'][0])
    {
        $returnType = '';
        $request = $this->setRoundcubeSsoEnabledRequest($server_id, $body, $contentType);
    ...
    /**
     * Create request for operation 'setRoundcubeSsoEnabled'
     *
     * @param  string $server_id The UUID of the server (required)
     * @param  bool $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['setRoundcubeSsoEnabled'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function setRoundcubeSsoEnabledRequest($server_id, $body, string $contentType = self::contentTypes['setRoundcubeSsoEnabled'][0])
    {

        // verify the required parameter 'server_id' is set
        if ($server_id === null || (is_array($server_id) && count($server_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $server_id when calling setRoundcubeSsoEnabled'
            );
        }
        ...
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling setRoundcubeSsoEnabled'
            );
        }
     ...
     * @return void
     */
    public function uninstallServerRole($server_id, $role, $disable_role_on_installation = null, string $contentType = self::contentTypes['uninstallServerRole'][0])
    {
        $this->uninstallServerRoleWithHttpInfo($server_id, $role, $disable_role_on_installation, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function uninstallServerRoleWithHttpInfo($server_id, $role, $disable_role_on_installation = null, string $contentType = self::contentTypes['uninstallServerRole'][0])
    {
        $request = $this->uninstallServerRoleRequest($server_id, $role, $disable_role_on_installation, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uninstallServerRoleAsync($server_id, $role, $disable_role_on_installation = null, string $contentType = self::contentTypes['uninstallServerRole'][0])
    {
        return $this->uninstallServerRoleAsyncWithHttpInfo($server_id, $role, $disable_role_on_installation, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uninstallServerRoleAsyncWithHttpInfo($server_id, $role, $disable_role_on_installation = null, string $contentType = self::contentTypes['uninstallServerRole'][0])
    {
        $returnType = '';
        $request = $this->uninstallServerRoleRequest($server_id, $role, $disable_role_on_installation, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function uninstallServerRoleRequest($server_id, $role, $disable_role_on_installation = null, string $contentType = self::contentTypes['uninstallServerRole'][0])
    {
     ...
     * @return void
     */
    public function updateServerRole($server_id, $role, $update_server_role_request, $disable_role_on_installation = null, string $contentType = self::contentTypes['updateServerRole'][0])
    {
        $this->updateServerRoleWithHttpInfo($server_id, $role, $update_server_role_request, $disable_role_on_installation, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateServerRoleWithHttpInfo($server_id, $role, $update_server_role_request, $disable_role_on_installation = null, string $contentType = self::contentTypes['updateServerRole'][0])
    {
        $request = $this->updateServerRoleRequest($server_id, $role, $update_server_role_request, $disable_role_on_installation, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateServerRoleAsync($server_id, $role, $update_server_role_request, $disable_role_on_installation = null, string $contentType = self::contentTypes['updateServerRole'][0])
    {
        return $this->updateServerRoleAsyncWithHttpInfo($server_id, $role, $update_server_role_request, $disable_role_on_installation, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateServerRoleAsyncWithHttpInfo($server_id, $role, $update_server_role_request, $disable_role_on_installation = null, string $contentType = self::contentTypes['updateServerRole'][0])
    {
        $returnType = '';
        $request = $this->updateServerRoleRequest($server_id, $role, $update_server_role_request, $disable_role_on_installation, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateServerRoleRequest($server_id, $role, $update_server_role_request, $disable_role_on_installation = null, string $contentType = self::contentTypes['updateServerRole'][0])
    {
