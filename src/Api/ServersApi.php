...
/**
     ...
     * @return void
     */
    public function deleteSlave($server_id, $force = false, string $contentType = self::contentTypes['deleteSlave'][0])
    {
        $this->deleteSlaveWithHttpInfo($server_id, $force, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteSlaveWithHttpInfo($server_id, $force = false, string $contentType = self::contentTypes['deleteSlave'][0])
    {
        $request = $this->deleteSlaveRequest($server_id, $force, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteSlaveAsync($server_id, $force = false, string $contentType = self::contentTypes['deleteSlave'][0])
    {
        return $this->deleteSlaveAsyncWithHttpInfo($server_id, $force, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteSlaveAsyncWithHttpInfo($server_id, $force = false, string $contentType = self::contentTypes['deleteSlave'][0])
    {
        $returnType = '';
        $request = $this->deleteSlaveRequest($server_id, $force, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteSlaveRequest($server_id, $force = false, string $contentType = self::contentTypes['deleteSlave'][0])
    {
