...
class SettingsApi
{
     ...
     *
     * @param  \Upmind\EnhanceSdk\Model\DockerRegistry|null $docker_registry docker_registry (optional)
     ...
     * Updates the Docker registry credentials.
     *
     * @param  \Upmind\EnhanceSdk\Model\DockerRegistry|null $docker_registry (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['setDockerRegistry'] to see the possible values for this operation
     *
     * @throws \Upmind\EnhanceSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
