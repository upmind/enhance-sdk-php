...
class WebsitesApi
{
     ...
     * @param  string $setting_key A key for updating an existing setting (required)
     *
     * @throws \Upmind\EnhanceSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * @param  bool $show_deleted Filters out deleted websites, which are otherwise returned in the result. Defaults to &#x60;showDeleted&#x3D;true&#x60; if not set. Can only be set by the MO, if set by other 400 is returned. (optional)
    ...
    /**
     * Operation unauthorizeWebsiteSshPassword
     *
     ...
     * @return void
     */
    public function unauthorizeWebsiteSshPassword($org_id, $website_id)
    {
        $this->unauthorizeWebsiteSshPasswordWithHttpInfo($org_id, $website_id);
    }

    /**
     * Operation unauthorizeWebsiteSshPasswordWithHttpInfo
     *
     * Unauthorize SSH password for the given website.
     *
     * @param  string $org_id The id of the organization. (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function unauthorizeWebsiteSshPasswordWithHttpInfo($org_id, $website_id)
    {
        $request = $this->unauthorizeWebsiteSshPasswordRequest($org_id, $website_id);
    ...
    /**
     * Operation unauthorizeWebsiteSshPasswordAsync
     *
     * Unauthorize SSH password for the given website.
     *
     * @param  string $org_id The id of the organization. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unauthorizeWebsiteSshPasswordAsync($org_id, $website_id)
    {
        return $this->unauthorizeWebsiteSshPasswordAsyncWithHttpInfo($org_id, $website_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation unauthorizeWebsiteSshPasswordAsyncWithHttpInfo
     *
     * Unauthorize SSH password for the given website.
     *
     * @param  string $org_id The id of the organization. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unauthorizeWebsiteSshPasswordAsyncWithHttpInfo($org_id, $website_id)
    {
        $returnType = '';
        $request = $this->unauthorizeWebsiteSshPasswordRequest($org_id, $website_id);
    ...
    /**
     * Create request for operation 'unauthorizeWebsiteSshPassword'
     *
     * @param  string $org_id The id of the organization. (required)
     * @param  string $website_id The id of the website. (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function unauthorizeWebsiteSshPasswordRequest($org_id, $website_id)
    {

        // verify the required parameter 'org_id' is set
        if ($org_id === null || (is_array($org_id) && count($org_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $org_id when calling unauthorizeWebsiteSshPassword'
            );
        }
        ...
        if ($website_id === null || (is_array($website_id) && count($website_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $website_id when calling unauthorizeWebsiteSshPassword'
            );
        }
