...
class WebsitesApi
{
     ...
     * @param  string|null $clone_from The ID of the website to clone. Note that a website cannot be cloned from another website if the kind parameter is specified and different from &#x60;normal&#x60;. (optional)
