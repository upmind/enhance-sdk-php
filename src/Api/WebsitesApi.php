...
class WebsitesApi
{
     ...
     * @param  string $org_id The id of the organization. (required)
     * @param  string $website_id The id of the website. (required)
     * @param  \Upmind\EnhanceSdk\Model\CgroupLimits $cgroup_limits Cgroup limits. (required)
     *
     * @throws \Upmind\EnhanceSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function setWebsiteCgroupLimits($org_id, $website_id, $cgroup_limits)
    {
        $this->setWebsiteCgroupLimitsWithHttpInfo($org_id, $website_id, $cgroup_limits);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function setWebsiteCgroupLimitsWithHttpInfo($org_id, $website_id, $cgroup_limits)
    {
        $request = $this->setWebsiteCgroupLimitsRequest($org_id, $website_id, $cgroup_limits);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setWebsiteCgroupLimitsAsync($org_id, $website_id, $cgroup_limits)
    {
        return $this->setWebsiteCgroupLimitsAsyncWithHttpInfo($org_id, $website_id, $cgroup_limits)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setWebsiteCgroupLimitsAsyncWithHttpInfo($org_id, $website_id, $cgroup_limits)
    {
        $returnType = '';
        $request = $this->setWebsiteCgroupLimitsRequest($org_id, $website_id, $cgroup_limits);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function setWebsiteCgroupLimitsRequest($org_id, $website_id, $cgroup_limits)
    {
        ...
        // verify the required parameter 'cgroup_limits' is set
        if ($cgroup_limits === null || (is_array($cgroup_limits) && count($cgroup_limits) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cgroup_limits when calling setWebsiteCgroupLimits'
            );
        }
        ...
        // for model (json/xml)
        if (isset($cgroup_limits)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($cgroup_limits));
            } else {
                $httpBody = $cgroup_limits;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
