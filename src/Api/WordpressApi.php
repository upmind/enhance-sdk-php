...
class WordpressApi
{
    ...
    /**
     * Operation getWordpressInfo
     *
     * @param  string $org_id The id of the organization. (required)
     * @param  string $website_id The id of the website. (required)
     * @param  string $app_id The id of the app. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getWordpressInfo'] to see the possible values for this operation
     *
     * @throws \Upmind\EnhanceSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Upmind\EnhanceSdk\Model\WordPressInfo
     */
    public function getWordpressInfo($org_id, $website_id, $app_id, string $contentType = self::contentTypes['getWordpressInfo'][0])
    {
        list($response) = $this->getWordpressInfoWithHttpInfo($org_id, $website_id, $app_id, $contentType);
        return $response;
    }

    /**
     * Operation getWordpressInfoWithHttpInfo
     *
     * @param  string $org_id The id of the organization. (required)
     * @param  string $website_id The id of the website. (required)
     * @param  string $app_id The id of the app. (required)
     ...
     * @throws \Upmind\EnhanceSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Upmind\EnhanceSdk\Model\WordPressInfo, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWordpressInfoWithHttpInfo($org_id, $website_id, $app_id, string $contentType = self::contentTypes['getWordpressInfo'][0])
    {
        $request = $this->getWordpressInfoRequest($org_id, $website_id, $app_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Upmind\EnhanceSdk\Model\WordPressInfo' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Upmind\EnhanceSdk\Model\WordPressInfo' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Upmind\EnhanceSdk\Model\WordPressInfo', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Upmind\EnhanceSdk\Model\WordPressInfo';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Upmind\EnhanceSdk\Model\WordPressInfo',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getWordpressInfoAsync
     *
     * @param  string $org_id The id of the organization. (required)
     * @param  string $website_id The id of the website. (required)
     * @param  string $app_id The id of the app. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWordpressInfoAsync($org_id, $website_id, $app_id, string $contentType = self::contentTypes['getWordpressInfo'][0])
    {
        return $this->getWordpressInfoAsyncWithHttpInfo($org_id, $website_id, $app_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getWordpressInfoAsyncWithHttpInfo
     *
     * @param  string $org_id The id of the organization. (required)
     * @param  string $website_id The id of the website. (required)
     * @param  string $app_id The id of the app. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWordpressInfoAsyncWithHttpInfo($org_id, $website_id, $app_id, string $contentType = self::contentTypes['getWordpressInfo'][0])
    {
        $returnType = '\Upmind\EnhanceSdk\Model\WordPressInfo';
        $request = $this->getWordpressInfoRequest($org_id, $website_id, $app_id, $contentType);
    ...
    /**
     * Create request for operation 'getWordpressInfo'
     *
     * @param  string $org_id The id of the organization. (required)
     * @param  string $website_id The id of the website. (required)
     * @param  string $app_id The id of the app. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getWordpressInfoRequest($org_id, $website_id, $app_id, string $contentType = self::contentTypes['getWordpressInfo'][0])
    {

        // verify the required parameter 'org_id' is set
        if ($org_id === null || (is_array($org_id) && count($org_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $org_id when calling getWordpressInfo'
            );
        }
        ...
        if ($website_id === null || (is_array($website_id) && count($website_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $website_id when calling getWordpressInfo'
            );
        }
        ...
        if ($app_id === null || (is_array($app_id) && count($app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_id when calling getWordpressInfo'
            );
        }


        $resourcePath = '/orgs/{org_id}/websites/{website_id}/apps/{app_id}/wordpress/info';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
