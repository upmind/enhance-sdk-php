...
class WordpressApi
{
     ...
     * @param  string $website_id The id of the website. (required)
     * @param  string $app_id The id of the app. (required)
     * @param  \Upmind\EnhanceSdk\Model\UpdateWpAppToVersion|null $update_wp_app_to_version update_wp_app_to_version (optional)
     ...
     * @param  string $website_id The id of the website. (required)
     * @param  string $app_id The id of the app. (required)
     * @param  \Upmind\EnhanceSdk\Model\UpdateWpAppToVersion|null $update_wp_app_to_version (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateWordpressAppVersion'] to see the possible values for this operation
     *
     * @throws \Upmind\EnhanceSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
