...
class BackupRestoreOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPIFormats = [
        'restore_files' => null,
        'restore_only_files' => null,
        'restore_emails' => null,
        'restore_all_emails' => null,
        'restore_databases' => null,
        'restore_postgresql_databases' => null
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('restore_only_files', $data ?? [], null);
        ...
        $this->setIfExists('restore_postgresql_databases', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets restore_only_files
     *
     * @return string[]|null
     */
    public function getRestoreOnlyFiles()
    {
        return $this->container['restore_only_files'];
    }

    /**
     * Sets restore_only_files
     *
     * @param string[]|null $restore_only_files Used in conjunction with the restoreFiles parameter, will limit the restoration to only the files/directories specified.
     *
     * @return self
     */
    public function setRestoreOnlyFiles($restore_only_files)
    {
        if (is_null($restore_only_files)) {
            throw new \InvalidArgumentException('non-nullable restore_only_files cannot be null');
        }
        $this->container['restore_only_files'] = $restore_only_files;
    ...
    /**
     * Gets restore_postgresql_databases
     *
     * @return string[]|null
     */
    public function getRestorePostgresqlDatabases()
    {
        return $this->container['restore_postgresql_databases'];
    }

    /**
     * Sets restore_postgresql_databases
     *
     * @param string[]|null $restore_postgresql_databases The list of PostgreSQL database names that need to be restored. If this list is not specified all the databases found in the backup snapshot will be restored, otherwise if this list is specified as empty, no database will be restored.
     *
     * @return self
     */
    public function setRestorePostgresqlDatabases($restore_postgresql_databases)
    {
        if (is_null($restore_postgresql_databases)) {
            throw new \InvalidArgumentException('non-nullable restore_postgresql_databases cannot be null');
        }
        $this->container['restore_postgresql_databases'] = $restore_postgresql_databases;
