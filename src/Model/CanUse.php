...
class CanUse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('roundcube_sso', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['postgresql'] === null) {
            $invalidProperties[] = "'postgresql' can't be null";
        }
     ...
     * @return bool|null
     */
    public function getRoundcubeSso()
    {
        return $this->container['roundcube_sso'];
    }

    /**
     * Sets roundcube_sso
     *
     * @param bool|null $roundcube_sso roundcube_sso
     *
     * @return self
     */
    public function setRoundcubeSso($roundcube_sso)
    {
        if (is_null($roundcube_sso)) {
            throw new \InvalidArgumentException('non-nullable roundcube_sso cannot be null');
        }
        $this->container['roundcube_sso'] = $roundcube_sso;
     ...
     * Sets postgresql
     *
     * @param bool $postgresql postgresql
     *
     * @return self
     */
