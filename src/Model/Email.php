...
class Email implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('sso_available', $data ?? [], null);
    }
    ...
    */
     ...
     * @return bool|null
     */
    public function getSsoAvailable()
    {
        return $this->container['sso_available'];
    }

    /**
     * Sets sso_available
     *
     * @param bool|null $sso_available sso_available
     *
     * @return self
     */
    public function setSsoAvailable($sso_available)
    {
        if (is_null($sso_available)) {
            throw new \InvalidArgumentException('non-nullable sso_available cannot be null');
        }
        $this->container['sso_available'] = $sso_available;
