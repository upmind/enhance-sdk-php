...
class ListedPersistentApp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'id' => 'string',
        'app_kind' => '\Upmind\EnhanceSdk\Model\PersistentAppKind'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('app_kind', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets app_kind
     *
     * @return \Upmind\EnhanceSdk\Model\PersistentAppKind|null
     */
    public function getAppKind()
    {
        return $this->container['app_kind'];
    }

    /**
     * Sets app_kind
     *
     * @param \Upmind\EnhanceSdk\Model\PersistentAppKind|null $app_kind app_kind
     *
     * @return self
     */
    public function setAppKind($app_kind)
    {
        if (is_null($app_kind)) {
            throw new \InvalidArgumentException('non-nullable app_kind cannot be null');
        }
        $this->container['app_kind'] = $app_kind;
