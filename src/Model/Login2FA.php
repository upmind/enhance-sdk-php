...
class Login2FA implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'auth_method' => 'string',
        'pin' => 'string',
        'remember_me' => '\Upmind\EnhanceSdk\Model\Login2FARememberMe'
    ];
    ...
    */
     ...
     * Gets remember_me
     *
     * @return \Upmind\EnhanceSdk\Model\Login2FARememberMe|null
     */
     ...
     * Sets remember_me
     *
     * @param \Upmind\EnhanceSdk\Model\Login2FARememberMe|null $remember_me remember_me
     *
     * @return self
     */
