...
class NewWebsiteApp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets admin_username
     *
     * @param string|null $admin_username This username is going to be the username of the initial WP user with which the user can login to the WP admin. This is equivalent to going to `wp-admin/install.php` and performing the install from there.
     *
     * @return self
     */
     ...
     * Sets admin_password
     *
     * @param string|null $admin_password Complements the admin username. Provide unhashed password.
     *
     * @return self
     */
     ...
     * Sets admin_email
     *
     * @param string|null $admin_email Sets the admin email address, required by some applications.
     *
     * @return self
     */
