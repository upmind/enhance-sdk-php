...
/**
 * PostgresqlRoleInfo Class Doc Comment
 *
 * @category Class
 * @package  Upmind\EnhanceSdk
 * @author   OpenAPI Generator team
 ...
 */
class PostgresqlRoleInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostgresqlRoleInfo';
    ...
    */
     ...
     * Sets websites_count
     *
     * @param int $websites_count The number of websites whose databases are assigned to be on this PostgreSQL role.
     *
     * @return self
     */
