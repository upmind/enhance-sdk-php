...
class ServerInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'created_at' => 'string',
        'controld' => '\Upmind\EnhanceSdk\Model\ServiceInfo',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('controld', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['controld'] === null) {
            $invalidProperties[] = "'controld' can't be null";
        }
     ...
     */
    public function getControld()
    {
        return $this->container['controld'];
    }

    /**
     * Sets controld
     *
     * @param \Upmind\EnhanceSdk\Model\ServiceInfo $controld controld
     *
     * @return self
     */
    public function setControld($controld)
    {

        if (is_null($controld)) {
            throw new \InvalidArgumentException('non-nullable controld cannot be null');
        }

        $this->container['controld'] = $controld;
