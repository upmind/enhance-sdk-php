 ...
 */
class ServerSpecs implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ServerSpecs';
    ...
    public const ARCHITECTURE_UNKNOWN_DEFAULT_OPEN_API = 'unknown_default_open_api';
    ...
    public function getArchitectureAllowableValues()
    {
        return [
            ...
            self::ARCHITECTURE_UNKNOWN_DEFAULT_OPEN_API,
        ];
    }
    ...
    {
        $this->setIfExists('cpu_kind', $data ?? [], null);
        $this->setIfExists('cpu_mhz', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cpu_kind'] === null) {
            $invalidProperties[] = "'cpu_kind' can't be null";
        }
        if ($this->container['cpu_mhz'] === null) {
            $invalidProperties[] = "'cpu_mhz' can't be null";
        }
     ...
     * @return string
     */
    public function getCpuKind()
    {
        return $this->container['cpu_kind'];
    }

    /**
     * Sets cpu_kind
     *
     * @param string $cpu_kind cpu_kind
     *
     * @return self
     */
    public function setCpuKind($cpu_kind)
    {
        if (is_null($cpu_kind)) {
            throw new \InvalidArgumentException('non-nullable cpu_kind cannot be null');
        }
        $this->container['cpu_kind'] = $cpu_kind;
    ...
    {
        return $this->container['cpu_mhz'];
    }

    /**
     * Sets cpu_mhz
     *
     * @param float $cpu_mhz cpu_mhz
     *
     * @return self
     */
    public function setCpuMhz($cpu_mhz)
    {
        if (is_null($cpu_mhz)) {
            throw new \InvalidArgumentException('non-nullable cpu_mhz cannot be null');
        }
        $this->container['cpu_mhz'] = $cpu_mhz;
     ...
     * Sets cpu_cores
     *
     * @param float $cpu_cores cpu_cores
     *
     * @return self
     */
    ...
    public function setArchitecture($architecture)
    {
        ...
        if (!in_array($architecture, $allowedValues, true)) {
            $architecture = self::ARCHITECTURE_UNKNOWN_DEFAULT_OPEN_API;
        }
